			...
			<div class="row header">
				...
				<div class="col-md-6">
						...
						<div class="input-group">
							<input type="text" class="form-control input-lg" style="color: #000000; 	font-size:15px; opacity: .8;" placeholder="Bengaluru, IN">
	...
	<div class="row" style="padding:19px">
			...
			<div id="bengaluru">
				<div class="row" style="padding: 40px;">
					...
					<div ng-repeat="cityName in cityList.city">
						<div ng-if="'Bengaluru'==cityName"> 
							<span style="font-size:30px;"> {{cityName}}, Karnataka</span><br>
						</div>
					</div>
						<span style="font-size:25px;">Thursday, 2:25 PM</span><br><br>
						<span style="font-size:40px;color:#007896;"><img src="images/cloudy.png"> 26&deg </span>
						...
						<div class="row" style="font-size: 20px;"><br>
							<div class="col-md-10	pull-right">
								<ul class="center" style="list-style-type:square;">
													<li>Precipitation : <span style="color:#007896;">0%</span></li>
													<li>Humidity : <span style="color:#007896;">76%</span></li>
													<li><span>Wind : <span style="color:#007896;">34 km/h</span></li>
								</ul>
							</div>
						</div>
					</div>
						  ...
						  <div class="panel-body" align="center">
							<div class="col-md-2">
								<div style="cursor:pointer;">
									...
									<br><br>
									<center><span style="color:#8e8e8e">27&deg</span> 20&deg</center>
								</div>
							</div>
							...
							<div class="col-md-2">
								<div style="cursor:pointer;">
									...
									<br><br>
									<center><span style="color:#8e8e8e">27&deg</span> 20&deg</span><center>
								</div>	
							</div>
							...
							<div class="col-md-2">
								<div style="cursor:pointer;">
									...
									<br><br>
									<center><span style="color:#8e8e8e">26&deg</span> 20s&deg</center>
								</div>	
							</div>
							...
							<div class="col-md-2">
								<div style="cursor:pointer;">
									...
									<img src="images/Drizzle.png">
									<br><br>
									<center><span style="color:#8e8e8e">26&deg</span> 20&deg</center>
								</div>	
							</div>
						  </div>
						</div>
		...
		<div class="col-md-3 city-panel custom-padding" >
			<div class="panel panel-info">
				...
				<div class="row" style="margin-left:10px;margin-right:10px;padding-top:2px;padding-bottom:2px;"><br>					
