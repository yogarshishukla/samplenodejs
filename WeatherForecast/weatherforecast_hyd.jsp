			...
			<div class="row header">
				...
				<div class="col-md-6">
						...
						<div class="input-group">
							<input type="text" class="form-control input-lg" style="color: #000000; 	font-size:15px; opacity: .8;" placeholder="Hyderabad, IN">
				...
				<div class="row" style="padding: 40px;">
					<div class="col-md-6" >
						<div ng-repeat="cityName in cityList.city">
							<div ng-if="'Hyderabad'==cityName"> 
								<span style="font-size:30px;"> {{cityName}}, Telangana</span><br>
							</div>
						</div>	
						<span style="font-size:25px;">Thursday, 2:25 PM</span><br><br>
						<span style="font-size:40px;color:#007896;"><img src="images/cloudy.png"> 29&deg </span>
						...
						<div class="row" style="font-size: 20px;"><br>
							<div class="col-md-10	pull-right">
								<ul class="center" style="list-style-type:square;">
													<li>Precipitation : <span style="color:#007896;">40%</span></li>
													<li>Humidity : <span style="color:#007896;">62%</span></li>
													<li><span>Wind : <span style="color:#007896;">19 km/h</span></li>
								</ul>
							</div>
						</div>
					</div>
						  ...
						  <div class="panel-body" align="center">
							<div class="col-md-2">
								<div style="cursor:pointer;">
									...
									<br><br>
									<center><span style="color:#8e8e8e">30&deg</span> 22&deg</center>
								</div>
							</div>
							...
							<div class="col-md-2">
								<div style="cursor:pointer;">
									...
									<br><br>
									<center><span style="color:#8e8e8e">39&deg</span> 22&deg</center>
								</div>
							</div>
							...
							<div class="col-md-2">
								<div style="cursor:pointer;">
									...
									<br><br>
									<center><span style="color:#8e8e8e">31&deg</span> 22&deg</center>
								</div>	
							</div>
							...
							<div class="col-md-2">
								<div style="cursor:pointer;">
									...
									<img src="images/rain.png">
									<br><br>
									<center><span style="color:#8e8e8e">30&deg</span> 22&deg</span><center>
								</div>	
							</div>
							...
							<div class="col-md-2">
								<div style="cursor:pointer;">
									...
									<img src="images/rain.png">
									<br><br>
									<center><span style="color:#8e8e8e">29&deg</span> 22&deg</center>
								</div>	
							</div>
