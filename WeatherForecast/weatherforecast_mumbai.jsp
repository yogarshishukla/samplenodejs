			...
			<div class="row header">
				...
				<div class="col-md-6">
						...
						<div class="input-group">
							<input type="text" class="form-control input-lg" style="color: #000000; 	font-size:15px; opacity: .8;" placeholder="Mumbai, IN">
				...
				<div class="row" style="padding: 40px;">
					<div class="col-md-6" >
						<div ng-repeat="cityName in cityList.city">
							<div ng-if="'Mumbai'==cityName"> 
								<span style="font-size:30px;"> {{cityName}}, Maharashtra</span><br>
							</div>
						</div>
						<span style="font-size:25px;">Thursday, 2:25 PM</span><br><br>
						<span style="font-size:40px;color:#007896;"><img src="images/Drizzle_Large.png"> 27&deg </span>
						...
						<div class="row" style="font-size: 20px;"><br>
							<div class="col-md-10	pull-right">
								<ul class="center" style="list-style-type:square;">
													<li>Precipitation : <span style="color:#007896;">2%</span></li>
													<li>Humidity : <span style="color:#007896;">88%</span></li>
													<li><span>Wind : <span style="color:#007896;">23 km/h</span></li>
								</ul>
							</div>
						</div>
					</div>
						  ...
						  <div class="panel-body" align="center">
							<div class="col-md-2">
								<div style="cursor:pointer;">
									...
									<br><br>
									<center><span style="color:#8e8e8e">27&deg</span> 22&deg</center>
								</div>
							</div>
							...
							<div class="col-md-2">
								<div style="cursor:pointer;">
									...
									<img src="images/Drizzle.png">
									<br><br>
									<center><span style="color:#8e8e8e">28&deg</span> 22&deg</center>
								</div>
							</div>
							...
							<div class="col-md-2">
								<div style="cursor:pointer;">
									...
									<img src="images/Drizzle.png">
									<br><br>
									<center><span style="color:#8e8e8e">28&deg</span> 23&deg</center>
								</div>	
							</div>
							...
							<div class="col-md-2">
								<div style="cursor:pointer;">
									...
									<img src="images/Drizzle.png">
									<br><br>
									<center><span style="color:#8e8e8e">28&deg</span> 22&deg</span><center>
								</div>	
							</div>
							...
							<div class="col-md-2">
								<div style="cursor:pointer;">
									...
									<img src="images/Drizzle.png">
									<br><br>
									<center><span style="color:#8e8e8e">29&deg</span> 23&deg</center>
								</div>	
							</div>
		...
		<div class="col-md-3 city-panel custom-padding" >
			<div class="panel panel-info">
				...
				<div class="row" style="margin-left:10px;margin-right:10px;padding:2px;"><br>					
						<a href="weatherforecast_bengaluru.jsp" class="custom-anchor">
							<div class="col-md-8">
								...
								<span style="font-size:13px;color:#818181;">Cloudy with Rainfall</span>
							</div>
							<div class="col-md-4">
				...
				<div class="row" style="margin-left:10px;margin-right:10px;padding:2px;">					
						<a href="weatherforecast_delhi.jsp" class="custom-anchor">
							<div class="col-md-8">
								<div>
									<span style="font-size:17px;color:#a3372b;">Delhi</span>
								</div>
								<span style="font-size:13px;color:#818181;">Cloudy</span>
							</div>
							<div class="col-md-4">
								<span style="font-size:15px;color:#555555;"><img src="images/cloudy.png">24&deg</span>
							</div>
						</a>
				</div><hr>
